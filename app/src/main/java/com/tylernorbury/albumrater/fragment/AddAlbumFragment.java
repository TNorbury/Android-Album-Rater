    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                ...
                String albumName = ((TextView)form.findViewById(R.id.add_album_name)).getText().toString();
                ...
                String albumArtist = ((TextView)form.findViewById(R.id.add_album_artist)).getText().toString();
                ...
                int selectedRating = ((RadioGroup)form.findViewById(R.id.add_album_rating)).getCheckedRadioButtonId();
                ...
                // If the form is considered "valid", then we want to insert the data into the database
                if (validForm) {
                    Album album = new Album(albumName, albumArtist, albumRating);

                    // Get the album view model from the parent activity and then insert the new album
