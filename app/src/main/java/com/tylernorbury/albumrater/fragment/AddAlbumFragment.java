...
public class AddAlbumFragment extends Fragment
{
    ...
    Button.OnClickListener mButtonClickListener = new Button.OnClickListener()
    {
        public void onClick(View v)
        {
            ...
            String albumName = ((TextView) form.findViewById(R.id.add_album_title)).getText()
                    .toString();
            ...
            String albumArtist = ((TextView) form.findViewById(R.id.add_album_artist)).getText()
                    .toString();
            ...
            int selectedRating = ((RadioGroup) form.findViewById(R.id.add_album_rating))
            ...
            String albumReview = ((TextView) form.findViewById(R.id.add_album_review)).getText()
                    .toString();
            ...
            else
            {
                Toast.makeText(AlbumRaterApp.getContext(),
                        getString(R.string.invalid_album_form_message), Toast.LENGTH_LONG).show();
            }
        }
    };
