...
public class EditAlbumFragment extends Fragment {
    ...
    Button.OnClickListener mSubmitEditButtonListener = new Button.OnClickListener()
    {
        ...
        public void onClick(View v)
        {
            ...
            String albumName = ((TextView) form
                    .findViewById(R.id.edit_album_title)).getText().toString();
            ...
            String albumArtist = ((TextView) form
                    .findViewById(R.id.edit_album_artist)).getText().toString();
            ...
            int selectedRating = ((RadioGroup) form
                    .findViewById(R.id.edit_album_rating)).getCheckedRadioButtonId();
            ...
            // Get the text review
            String albumReview = ((TextView) form.findViewById(R.id.edit_album_review))
                    .getText().toString();
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        else if (getArguments().getInt(getString(R.string.original_album_rating))
                == Album.BAD_ALBUM) {
        ...
        ((EditText) view.findViewById(R.id.edit_album_review)).setText(getArguments()
                .getString(getString(R.string.original_album_review)));
        ...
        ((Button) view.findViewById(R.id.btn_cancel_edit)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        ((Button) view.findViewById(R.id.btn_submit_edit)).setOnClickListener(mSubmitEditButtonListener);
    }
}
