...
public class EditAlbumFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        ((Button) view.findViewById(R.id.btn_submit_edit)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                String albumName = ((TextView)view
                ...
                String albumArtist = ((TextView)view
                ...
                int selectedRating = ((RadioGroup)view
